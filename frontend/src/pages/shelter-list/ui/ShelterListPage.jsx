...
const ShelterListPage = () => {
  ...
  const { data: animals = [], error, isLoading } = useGetShelterAnimals();
        ...
        <div className="Map-wrapper">
          <Map
            ...
            onSelect={(shelter) => {
              ...
              setIsShelterInfoOpen(true);
            }}
            setCenterRef={mapRef}
          />
          {isShelterInfoOpen && selectedShelter && (
            <ShelterInfo shelter={selectedShelter} onClose={() => setIsShelterInfoOpen(false)} />
          )}
        </div>
