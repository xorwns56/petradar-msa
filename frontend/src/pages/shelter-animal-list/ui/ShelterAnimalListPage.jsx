...
import ShelterAnimalItem from "@/entities/shelter/ui/ShelterAnimalItem";
import ShelterAnimalModalDetail from "@/entities/shelter/ui/ShelterAnimalModalDetail";
import Header from "@/widgets/header/ui/Header";

const ShelterAnimalListPage = () => {
  // React Query로 보호소 데이터 조회
  const { data: animals = [] } = useGetShelterAnimals();
...
export default ShelterAnimalListPage;
