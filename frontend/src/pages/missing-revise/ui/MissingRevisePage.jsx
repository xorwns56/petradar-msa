...
import { useGetMissingDetail, useUpdateMissing } from "@/entities/missing/api/missingApi";

const MissingRevisePage = () => {
  const params = useParams();
  const nav = useNavigate();

  // React Query로 기존 데이터 로드
  const { data: missingData } = useGetMissingDetail(params.petMissingId);
...
export default MissingRevisePage;
